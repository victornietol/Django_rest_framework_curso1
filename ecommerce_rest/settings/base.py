...
SECRET_KEY = "django-insecure-mw)qk51mf6=yjexk$qs)k%-cpje!)pw7thm(w@lzsnqlnnntvj"
...
TOKEN_EXPIRED_AFTER_SECONDS = 900 # Variable personalizada para la expiracion de tokens en authentication.py (segundos)
